...
.hacker-score {
  ...
  text-shadow: 0 0 10px var(--theme-accent, #00ff41);
...
.game-over-title {
  font-family: monospace;
  color: var(--theme-accent, #00ff41);
  text-shadow: 0 0 20px var(--theme-accent, #00ff41), 0 0 40px var(--theme-accent, #00ff41);
  font-size: 2.8em;
...
@keyframes pulse-glow {
  from { text-shadow: 0 0 10px var(--theme-accent, #00ff41); }
  to { text-shadow: 0 0 20px var(--theme-accent, #00ff41), 0 0 40px #ffcc00; }
}

.game-over-restart {
  font-family: monospace;
  color: var(--theme-accent, #00ff41);
  text-shadow: 0 0 8px var(--theme-accent, #00ff41);
  font-size: 0.9em;
  letter-spacing: 0.1em;
  opacity: 0.8;
  margin-top: 1em;
