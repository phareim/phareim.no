      ...
      <div class="home">
        ...
        <div class="social-links">
          <SocialLink 
            ...
            :svg-content="linkedInSvg"
            css-class="linkedIn"
          />
          <SocialLink 
            href="https://bsky.app/profile/phareim.no"
            :svg-content="blueskySvg"
            css-class="bluesky"
            view-box="0 0 64 57"
