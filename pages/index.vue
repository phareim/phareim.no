<template>
  <div class="container">
    ...
    <div class="social-links">
      <a href="https://www.linkedin.com/in/phareim" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50"
          height="50" viewBox="0 0 50 50" style="fill:#1A1A1A;">
          <path
      ...
      <a href="https://twitter.com/phareim" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50"
          viewBox="0 0 50 50" style="fill:#1A1A1A;">
          <path
...
export default {
  ...
  isColliding(box1, box2) {
    ...
    addBox(event) {
      ...
      this.boxes.push({ x, y, vx: 2, vy: 2, size: (Math.random() * 20)+5, color });
    },
  },
};
</script>
...
.social-links a {
  z-index: 3;
  margin: 0 10px;
  /* light grey text shadow */
  text-shadow: 0px 0px 3px #999;
  /* Sørger for at lenkene er i forgrunn */
}</style>
