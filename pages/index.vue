  ...
  <div class="container">
    ...
    <div class="overlay" @click="addBox">
      <div class="home">
        ...
        <a href="https://bsky.app/profile/phareim.no" target="_blank">
          <svg fill="none" viewBox="0 0 64 57" width="28" style="width: 50; height: 50" class="bluesky">
...
.social-links svg.bluesky:hover {
  fill: #0385ff;
}
