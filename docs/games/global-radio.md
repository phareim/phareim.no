...
Portalen holder den fra den monteres (`audio.holdRadio()`), før første
tastetrykk; `dispose` slipper den og gjenopptar radioen hvis den spilte og
ikke er mutet. Widgeten er skjult på portalen (`app.vue`), der navneskiltet
ligger øverst til høyre.
