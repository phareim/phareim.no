...
themes/              — see the phareim-theme skill
  ...
  base/              — DefaultLanding shell, ProfileCard, SocialLink, neonHorizon.js (the shared synthwave backdrop: sky, stars, striped sun, ridge, grid, heartbeat, wave-clear flare — used by Breakout and Invaders since 2026-09-06; Star Fox draws its own in three.js)
