...
themes/              — see the phareim-theme skill
  ...
  base/              — DefaultLanding shell, ProfileCard, SocialLink, neonHorizon.js (the shared synthwave backdrop: sky, stars, striped sun, ridge, grid, heartbeat — used by Breakout; Invaders and Star Fox still draw their own, 2026-09-06)
