...
themes/              — see the phareim-theme skill
  ...
  scandi/ hacker/ space/ tufte/ desk/ almanac/
...
- Six themes, in swipe order: **Scandinavian Glass**, **Cyberpunk**, **Space**, **Tufte**, **Tufte Desk** (the tactile paper-on-desk layer from the tufte-viz design system, added 2026-09-03), **Almanac** (the reverted May 2026 paper redesign, back as a theme 2026-09-03). Desk and Almanac are the scrollable landings. First visit: random. Then: the `theme` cookie (one year). `?theme=<id>` overrides and re-sets the cookie.
