...
## Cyberpunk refresh (2026-09-08)

`themes/hacker/SpaceInvaders.vue` keeps the starfield and vertical shooter,
...
`npm run test:hacker` tests both side entrances and exits, armour damage and
