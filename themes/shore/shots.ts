...
const arch: Shot = {
  ...
  land: comp(
    ...
    [
      // the lintel (stage y 200..260 → frame 136..160) and its front stub
      P(NEAR, [166, 136], [204, 132], [208, 160], [168, 161]),
      P(NEAR, [198, 176], [200, 160], [208, 158], [216, 176]),
      // the arch: left leg, top, right leg
      P(NEAR, [0, 200], [0, 0], [30, 0], [34, 60], [30, 200]),
      P(NEAR, [30, 0], [112, 0], [112, 48], [96, 52], [70, 50], [48, 56], [34, 60]),
      P(NEAR, [96, 52], [112, 48], [110, 200], [98, 200]),
  ...
  port: comp(
    ...
    [
      P(NEAR, [104, 237], [128, 235], [130, 252], [106, 252]),
      P(NEAR, [124, 262], [126, 250], [130, 249], [136, 262]),
      P(NEAR, [0, 320], [0, 0], [18, 0], [20, 122], [18, 320]),
      P(NEAR, [18, 0], [68, 0], [68, 110], [58, 114], [40, 112], [20, 122]),
      P(NEAR, [58, 114], [68, 110], [66, 320], [60, 320]),
