<template><canvas ref="canvas" class="lb-horizon" aria-hidden="true" /></template>
<script setup>
...
<style scoped>
.lb-horizon { position: absolute; inset: 0; width: 100%; height: 100%; pointer-events: none; z-index: 0; }
</style>
